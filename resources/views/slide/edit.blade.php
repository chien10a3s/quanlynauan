                    ...
                    <div class="panel-body">
                        {!! Form::model($slide, ['route' => ['slide.update', $slide->id], 'method' => 'PUT', 'files'=>true]) !!}
                            <div class="form-group">
                            	{!! Form::label('heading', 'Tiêu đề') !!}
                            	{!! Form::text('heading', null, ['class' => 'form-control']) !!}
                            </div>
                            
                            <div class="form-group">
                            	{!! Form::label('image', 'Ảnh') !!}
                                <img src="{{ Voyager::image( $slide->image ) }}" style="width:200px; height:auto; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:10px;">
                                
                            	{!! Form::file('image') !!}
                            </div>
                            <!--
                            <div class="form-group">
                            	{!! Form::label('description', 'Link') !!}
