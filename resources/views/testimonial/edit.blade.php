                    ...
                    <div class="panel-body">
                        {!! Form::model($testimonial, ['route' => ['testimonial.update', $testimonial->id], 'method' => 'PUT', 'files'=>true]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ Voyager::image( $testimonial->image ) }}" style="width:200px; height:auto; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:10px;">
                                
                            	{!! Form::file('image') !!}
                            </div>
                            
                            <div class="form-group">
                            	{!! Form::label('about', 'Tiêu đề') !!}
                            	{!! Form::text('about', null, ['class' => 'form-control']) !!}
                            </div>
                            
                            
                            <div class="form-group">
                            	{!! Form::label('testimonial', 'Đánh giá') !!}
